---
title: "About"
description: "Decoupling from the Matrix"
---
...
graph TD
    ...
    subgraph The Consumption Trap
        A[Old Architecture: High Consumption] --> B[High Energy Demand]
        B --> C[Total Matrix Dependency]
    end

    %% Column 2: Vertical Flow
    subgraph Sovereign System Design
        D[New MPF Framework: Clean Baseline] --> E[Low Energy Demand]
        E --> F[Absolute Personal Sovereignty]
    end
